...
private extension Siren {
    ...
    func iTunesURLFromString() throws -> NSURL {
        ...
        if let appIdToCheck = appIdToCheck {
            items = [NSURLQueryItem(name: "id", value: "\(appIdToCheck)")]
        } else {
            items = [NSURLQueryItem(name: "bundleId", value: NSBundle.bundleID())]
        }
